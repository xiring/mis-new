                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if($row->is_active == 1)
                                            ...
                                            <a href="{{ route('fee.delete', $row->id) }}" class="dropdown-item">Delete</a>
                                        @else
                                            <a href="{{ route('fee.restore', $row->id) }}" class="dropdown-item">Restore</a>
                                        @endif
                                    </div>
                                </div>
                            </td>
                ...
                {{ Form::open(['route' => 'fee.store' , 'files' => true]) }}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="half_amount">
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editCat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'fee.update' , 'files' => true]) }}
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-form-label">Class</label>
