                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    @if($row->is_active == 1)
                                        ...
                                        <a href="{{ route('expense.invoice.delete', $row->id) }}" class="dropdown-item">Delete</a>
                                    @else
                                        <a href="{{ route('expense.invoice.restore', $row->id) }}" class="dropdown-item">Restore</a>
                                    @endif
                                </div>
                            </div>
                        </td>
    ...
    <div class="modal fade" id="addExpenseInv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'expense.invoice.store' , 'files' => true]) }}
    ...
    <div class="modal fade" id="editExpenseInv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'expense.invoice.update' , 'files' => true]) }}
                <div class="modal-body">
                    <div class="form-group">
