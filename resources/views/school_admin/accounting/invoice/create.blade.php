...
@section('customScript')
    <script>
        ...
        function getClassFees(class_id) {
            if (class_id !== '') {
                $.ajax({
                    url: '{{ url('/school/dashboard/class/fee') }}'+'/'+ class_id ,
                    success: function(response)
                    {
        ...
        function getClassFeesHalf(class_id) {
            if (class_id !== '') {
                $.ajax({
                    url: '{{ url('/school/dashboard/class/fee/half') }}'+'/'+ class_id ,
                    success: function(response)
                    {
        ...
        function getStudentTrans(student_id) {
            if (student_id !== '') {
                $.ajax({
                    url: '{{ url('/school/dashboard/student/transport') }}'+'/'+ student_id ,
                    success: function(response)
                    {
        ...
        function getScholarship(student_id) {
            if (student_id !== '') {
                $.ajax({
                    url: '{{ url('/school/dashboard/student/scholarship') }}'+'/'+ student_id ,
                    success: function(response)
                    {
        ...
        function getPreviousInvoice(student_id) {
            if (student_id !== '') {
                $.ajax({
                    url: '{{ url('/school/dashboard/student/previous/invoice') }}'+'/'+ student_id ,
                    success: function(response)
                    {
