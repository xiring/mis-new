        ...
        <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Invoice-{{ $invoice->id }}</a></li>
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header">
                <a class="btn btn-sm btn-rounded btn-info" onClick="PrintElem('#invoice_print')"><i class="fas fa-print"></i> Print</a>
            </div>
            <div class="card-body">
                <div id="invoice_print">
                    <table width="100%" border="0">
                        <tr>
                            <td align="left"><img src="https://samayapathshala.edu.np/public/assets/uploads/school/logo/logo%20(1)1555144152.png" alt="..." height="50px" width="70px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td>
