                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if($row->is_active == 1)
                                            ...
                                            <a href="{{ route('transport.view.student', $row->id) }}" class="dropdown-item">View Students</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="{{ route('transport.delete', $row->id) }}" class="dropdown-item">Delete</a>
                                        @else
                                            <a href="{{ route('transport.restore', $row->id) }}" class="dropdown-item">Restore</a>
                                        @endif
                                    </div>
                                </div>
                            </td>
    ...
    <div class="modal fade" id="addTransport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'transport.store' , 'files' => true]) }}
        ...
        <div class="modal fade" id="editTransport{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    {{ Form::open(['route' => 'transport.update' , 'files' => true]) }}
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-form-label">Route</label>
