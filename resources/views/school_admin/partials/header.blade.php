<div class="dashboard-header">
    <nav class="navbar navbar-expand-lg bg-primary fixed-top">
        <a class="navbar-brand" href="{{ route('school.dashboard') }}"> <img src="{{ asset($system_settings->logo) }}" class="img-link" height="40px"/> </a>
            ...
            <ul class="navbar-nav ml-auto navbar-right-top">
                ...
                <li class="nav-item ml-2">
                    <form method="get" action="{{ route('student.search') }}">
                        <div id="custom-search" class="top-search-bar">
                            <input class="form-control" name="student_name" required type="text" placeholder="Search Student..">
                        </div>
                    </form>
                </li>
                <li class="nav-item dropdown nav-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                        <div class="nav-user-info">
                            <h5 class="mb-0 text-white nav-user-name">{{ $system_settings->name }}</h5>
                        </div>
