...
@section('content')
    <div class="page-header" id="top">
        <h2 class="pageheader-title">Report of {{ $page }} & Class</h2>
        <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Invoices of class {{{ @$student->enroll->class->name }}} : {{ @$student->user->name }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body table-responsive">
            <form method="get" action="{{ route('report.class.student') }}">
                <div class="form-group">
                    <label class="col-form-label">Choose Class</label>
                    <select class="form-check-inline col-md-12 select2" name="class_id" onchange="getClassStudents(this.value);">
                ...
                <div class="form-group">
                    <label class="col-form-label">Choose Student</label>
                    <select class="form-check-inline col-md-12 select2" name="student_id" id="student_holder">
...
@section('customScript')
    ...
    <script>
        function getClassStudents(class_id) {
            if (class_id !== '') {
                $.ajax({
                    url: '{{ url('/school/dashboard/student') }}'+'/'+ class_id ,
