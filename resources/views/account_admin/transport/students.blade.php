        ...
        <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Transport</a></li>
            ...
            <table class="table table-striped" width="100%" id="datable1">
                ...
                @foreach($students as $row)
                    <tr>
                        ...
                        <td>
                            {{ $row->parent->user->name }}<br />
                            {{ $row->parent->phone }}
                        </td>
                        <td><a class="btn btn-link" href="{{ route('transport.accountant.remove.student', $row->id) }}"><i class="fas fa-trash"></i> Remove</a> </td>
                    </tr>
                @endforeach
                </tbody>
            </table>
